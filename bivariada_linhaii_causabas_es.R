# ANALISE BIVARIADA RELACIONANDO AS VARIÁVEIS CID LINHAII E CAUSABAS - ESPÍRITO SANTO
...
dados_es_linhaii$categoria_causabas <- sapply(dados_es_linhaii$CAUSABAS, categorizar_cid)
...
linhaii_causabas_es$categoria_causabas <- str_wrap(linhaii_causabas_es$categoria_causabas, width = 75)
...
linhaii_causabas_es$categoria_causabas <- factor(
  ...
  levels = linhaii_causabas_es$categoria_causabas[order(linhaii_causabas_es$quantidade, decreasing = FALSE)]
)


#plotar grafico plotly com as cids no eixo y e a quantidade do eixo x
gbarra_linhaii_causabas_es <- plot_ly(
  data = linhaii_causabas_es,
  x = ~quantidade,
...
df_i00ai99_es <- dados_es_linhaii %>%
...
# Aplicar a função de categorização
df_i00ai99_es$categoria_i00ai99 <- sapply(df_i00ai99_es$CAUSABAS, categorizar_cidi00ai99)
...
# Adicionar quebras de linha usando str_wrap
group_i00ai99_es$categoria_i00ai99 <- str_wrap(group_i00ai99_es$categoria_i00ai99, width = 75)

# Reordenar a variável 
group_i00ai99_es$categoria_i00ai99 <- factor(
  group_i00ai99_es$categoria_i00ai99, 
  levels = group_i00ai99_es$categoria_i00ai99[order(group_i00ai99_es$quantidade, decreasing = FALSE)]
)


#plotar grafico plotly com as cids no eixo y e a quantidade do eixo x
gbarra_i00ai99_es <- plot_ly(
  data = group_i00ai99_es,
  x = ~quantidade,
  y = ~categoria_i00ai99,
  type = 'bar',
  orientation = 'h'  # 'h' para horizontal
...
df_j00aj99_es <- dados_es_linhaii %>%
...
# Aplicar a função de categorização
df_j00aj99_es$categoria_j00aj99 <- sapply(df_j00aj99_es$CAUSABAS, categorizar_cidj00aj99)
...
group_j00aj99_es$categoria_j00aj99 <- factor(
  ...
  levels = group_j00aj99_es$categoria_j00aj99[order(group_j00aj99_es$quantidade, decreasing = FALSE)]
)


#plotar grafico plotly com as cids no eixo y e a quantidade do eixo x
gbarra_j00aj99_es <- plot_ly(
  data = group_j00aj99_es,
  x = ~quantidade,
  y = ~categoria_j00aj99,
  type = 'bar',
  orientation = 'h'  # 'h' para horizontal
...
df_c00ad48_es <- dados_es_linhaii %>%
...
# Aplicar a função de categorização
df_c00ad48_es$categoria_c00ad48 <- sapply(df_c00ad48_es$CAUSABAS, categorizar_cidc00ad48)
...
# Adicionar quebras de linha usando str_wrap
group_c00ad48_es$categoria_c00ad48 <- str_wrap(group_c00ad48_es$categoria_c00ad48, width = 80)

# Reordenar a variável 
group_c00ad48_es$categoria_c00ad48 <- factor(
  group_c00ad48_es$categoria_c00ad48, 
  levels = group_c00ad48_es$categoria_c00ad48[order(group_c00ad48_es$quantidade, decreasing = FALSE)]
)


#plotar grafico plotly com as cids no eixo y e a quantidade do eixo x
gbarra_c00ad48_es <- plot_ly(
  data = group_c00ad48_es,
  x = ~quantidade,
  y = ~categoria_c00ad48,
  type = 'bar',
  orientation = 'h'  # 'h' para horizontal
...
df_k00ak93_es <- dados_es_linhaii %>%
...
# Aplicar a função de categorização
df_k00ak93_es$categoria_k00ak93 <- sapply(df_k00ak93_es$CAUSABAS, categorizar_cidk00ak93)
...
group_k00ak93_es$categoria_k00ak93 <- factor(
  ...
  levels = group_k00ak93_es$categoria_k00ak93[order(group_k00ak93_es$quantidade, decreasing = FALSE)]
)


#plotar grafico plotly com as cids no eixo y e a quantidade do eixo x
gbarra_k00ak93_es <- plot_ly(
  data = group_k00ak93_es,
  x = ~quantidade,
  y = ~categoria_k00ak93,
  type = 'bar',
  orientation = 'h'  # 'h' para horizontal
...
df_f00af99_es <- dados_es_linhaii %>%
...
# Aplicar a função de categorização
df_f00af99_es$categoria_f00af99 <- sapply(df_f00af99_es$CAUSABAS, categorizar_cidf00af99)
...
group_f00af99_es$categoria_f00af99 <- factor(
  ...
  levels = group_f00af99_es$categoria_f00af99[order(group_f00af99_es$quantidade, decreasing = FALSE)]
)


#plotar grafico plotly com as cids no eixo y e a quantidade do eixo x
gbarra_f00af99_es <- plot_ly(
  data = group_f00af99_es,
  x = ~quantidade,
  y = ~categoria_f00af99,
  type = 'bar',
  orientation = 'h'  # 'h' para horizontal
