# Mortes por psicoativos registradas na base de dados do SIM: uma análise das variáveis relacionadas a causa do óbito

A seguinte análise faz parte de uma pesquisa que tem como objetivo entender o uso de Psicoativos no Estado do Espírito Santo. 
Para a pesquisa foi utilizada a base de dados do SIM e filtrados os dados de morte por psicoativos de acordo com as CID's relacionadas ao tema. 

Esse filtro pelas CID's foi aplicado em diferentes variáveis relacionadas à causa do óbito. A seguir segue a lista das variáveis investigadas e seus respectivos significados:

**CAUSABAS**: Causa básica da Declaração do óbito (DO);  
