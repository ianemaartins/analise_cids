...
obs.por.variavel.interativo <- ggplotly(obs.por.variavel, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ),
    yaxis = list(
      title = list(text = "Observações", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo Y
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo Y
    ),
    showlegend = FALSE  # Remove a legenda
  )

obs.por.variavel.es.interativo <- ggplotly(obs.por.variavel.es, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
...
# Usar subplot para colocar os gráficos lado a lado
subplot(obs.por.variavel.interativo, obs.por.variavel.es.interativo, nrows = 1, widths = c(0.49, 0.49)) %>%
  layout(
    title = list(text = "Número de Observações por Variável no Brasil e no ES", font = list(size = 16)),
    margin = list(l = 0, r = 0, t = 50, b = 50),
    xaxis = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o título do eixo X do primeiro gráfico
      domain = c(0, 0.45)
    ),
    xaxis2 = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o título do eixo X do segundo gráfico
      domain = c(0.55, 1)
    ),
    yaxis = list(
      title = list(text = "Observações", font = list(size = 14))  # Ajusta o título do eixo Y compartilhado
    ),
    spacing = 0.05  # Espaçamento entre os gráficos
  )
...
mortes.por.variavel.interativo <- ggplotly(mortes.por.variavel, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ),
    yaxis = list(
      title = list(text = "Mortes", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo Y
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo Y
    )
  )

mortes.por.variavel.es.interativo <- ggplotly(mortes.por.variavel.es, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
...
# Usar subplot para colocar os gráficos lado a lado
subplot(mortes.por.variavel.interativo, mortes.por.variavel.es.interativo, nrows = 1, widths = c(0.49, 0.49)) %>%
  layout(
    title = list(
      text = "Número de Mortes por Variável no Brasil e no ES", 
      font = list(size = 16)
    ),
    legend = list(
      title = list(text = "Variável CID", font = list(size = 12)),  # Ajustar o título da legenda
      font = list(size = 10),  # Ajustar o tamanho da fonte da legenda
      orientation = "h",  # Torna a legenda horizontal (opcional)
      x = 0.5,  # Centraliza a legenda horizontalmente
      xanchor = "center",  # Define o ponto de ancoragem
      y = -0.2  # Ajusta a posição da legenda (ajuste conforme necessário)
    ),
    margin = list(l = 0, r = 0, t = 50, b = 50),
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o título do eixo X do primeiro gráfico
      domain = c(0, 0.45)
    ),
    xaxis2 = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o título do eixo X do segundo gráfico
      domain = c(0.55, 1)
    ),
    yaxis = list(
      title = list(text = "Mortes", font = list(size = 14))  # Ajusta o título do eixo Y compartilhado
    ),
    spacing = 0.05  # Espaçamento entre os gráficos
  )
...
idade.por.variavel.interativo <- ggplotly(idade.por.variavel, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ...
    yaxis = list(
      title = list(text = "Média das Idades", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo Y
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo Y
    ),
    showlegend = FALSE  # Desativa a legenda deste gráfico para evitar duplicação
  )

idade.por.variavel.es.interativo <- ggplotly(idade.por.variavel.es, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ...
    legend = list(font = list(size = 14))  # Ajusta o tamanho da fonte da legenda
  )

# Usar subplot para colocar os gráficos lado a lado
subplot(idade.por.variavel.interativo, idade.por.variavel.es.interativo, nrows = 1, widths = c(0.49, 0.49)) %>%
  layout(
    title = list(
      text = "Idade Média das Mortes por Psicoativos no Brasil e no ES no Decorrer dos Anos", 
      font = list(size = 16)
    ),
    legend = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajustar o título da legenda
      font = list(size = 12),  # Ajustar o tamanho da fonte da legenda
      orientation = "h",  # Torna a legenda horizontal (opcional)
      x = 0.5,  # Centraliza a legenda horizontalmente
      xanchor = "center",  # Define o ponto de ancoragem
      y = -0.2  # Ajusta a posição da legenda (ajuste conforme necessário)
    ...
    margin = list(l = 0, r = 0, t = 50, b = 50),
    xaxis = list(
      title = list(text = "Idade Média de Morte", font = list(size = 14)),  # Ajusta o título do eixo X do primeiro gráfico
      domain = c(0, 0.45)
    ),
    xaxis2 = list(
      title = list(text = "Idade Média de Morte", font = list(size = 14)),  # Ajusta o título do eixo X do segundo gráfico
      domain = c(0.55, 1)
    ),
    yaxis = list(
      title = list(text = "Ano", font = list(size = 14))  # Ajusta o título do eixo Y compartilhado
    ),
    spacing = 0.05  # Espaçamento entre os gráficos
  )
...
boxplot.idades.interativo <- ggplotly(boxplot.idades) %>%
  layout(
    xaxis = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ...
    yaxis = list(
      title = list(text = "Idade", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo Y
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo Y
    ),
    legend = list(
      showlegend = FALSE  # Remove a legenda
...
boxplot.idades.es.interativo <- ggplotly(boxplot.idades.es) %>%
  layout(
    xaxis = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
...
# Usar subplot para colocar os gráficos lado a lado
subplot(boxplot.idades.interativo, boxplot.idades.es.interativo, nrows = 1, widths = c(0.49, 0.49)) %>%
  layout(
    title = list(text = "Relação de Idade por Variável CID no Brasil e no ES", font = list(size = 16)),
    margin = list(l = 0, r = 0, t = 50, b = 50),
    xaxis = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o eixo X do primeiro gráfico
      domain = c(0, 0.45)
    ),
    xaxis2 = list(
      title = list(text = "Variável CID", font = list(size = 14)),  # Ajusta o eixo X do segundo gráfico
      domain = c(0.55, 1)
    ),
    yaxis = list(
      title = list(text = "Idade", font = list(size = 14))  # Ajusta o título do eixo Y compartilhado
    ),
    spacing = 0.05  # Espaçamento entre os gráficos
  )
...
grafico.series.faixaeta.interativo <- ggplotly(grafico.series.faixaeta, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ...
    yaxis = list(
      title = list(text = "N. de Mortes", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo Y
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo Y
    )
  )

grafico.series.faixaeta.es.interativo <- ggplotly(grafico.series.faixaeta.es, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
...
# Usar subplot para colocar os gráficos lado a lado
subplot(grafico.series.faixaeta.interativo, grafico.series.faixaeta.es.interativo, nrows = 1, widths = c(0.49, 0.49)) %>%
  layout(
    title = list(text = "Mortes por Faixa Etária e Variável CID no Brasil e no ES no Decorrer dos Anos", font = list(size = 16)),
    margin = list(l = 0, r = 0, t = 50, b = 50),
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o eixo X do primeiro gráfico
      domain = c(0, 0.45)
    ),
    xaxis2 = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o eixo X do segundo gráfico
      domain = c(0.55, 1)
    ),
    yaxis = list(
      title = list(text = "N. de Mortes", font = list(size = 14))  # Ajusta o título do eixo Y compartilhado
    ),
    spacing = 0.05  # Espaçamento entre os gráficos
  )
...
grafico.series.genero.interativo <- ggplotly(grafico.series.genero, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
...
grafico.series.genero.es.interativo <- ggplotly(grafico.series.genero.es, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
...
# Usar subplot para colocar os gráficos lado a lado
subplot(grafico.series.genero.interativo, grafico.series.genero.es.interativo, nrows = 1, widths = c(0.49, 0.49)) %>%
  layout(
    title = list(text = "Mortes por Psicoativos de acordo com o Sexo e Variável CID", font = list(size = 16)),
    margin = list(l = 0, r = 0, t = 50, b = 50),
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o eixo X do primeiro gráfico
      domain = c(0, 0.45)
...
grafico.series.raca.interativo <- ggplotly(grafico.series.raca, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ...
    legend = list(
      traceorder = "reversed",  # Mantém a ordem das legendas
      title = list(text = "Legenda"),
      x = 0.9,  # Posição da legenda horizontal
      y = 1,  # Posição da legenda vertical
      orientation = "v"  # Orientação vertical da legenda
    )
  )

grafico.series.raca.es.interativo <- ggplotly(grafico.series.raca.es, tooltip = "text") %>%
  layout(
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o tamanho da fonte do título do eixo X
      tickfont = list(size = 11)  # Ajusta o tamanho da fonte dos valores no eixo X
    ...
    legend = list(
      traceorder = "reversed",  # Mantém as legendas separadas por grupo
      title = list(text = "Legenda"),
      x = 0.9,  # Posição da legenda horizontal
      y = 1,  # Posição da legenda vertical
      orientation = "v"  # Orientação vertical da legenda
...
# Usar subplot para colocar os gráficos lado a lado
subplot(grafico.series.raca.interativo, grafico.series.raca.es.interativo, nrows = 1, widths = c(0.49, 0.49)) %>%
  layout(
    title = list(text = "Mortes por Raça/Cor e Variável CID no Brasil e no ES no Decorrer dos Anos", font = list(size = 16)),
    margin = list(l = 0, r = 0, t = 50, b = 50),
    xaxis = list(
      title = list(text = "Ano", font = list(size = 14)),  # Ajusta o eixo X do primeiro gráfico
      domain = c(0, 0.45)
